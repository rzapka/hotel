    ...
    <div class="container">
        ...
        >
            <form @submit.prevent="submit">
                <h5 class="text-center mb-5">Zarezerwuj tor do kręgli</h5>
                <validation-provider
                    v-slot="{ errors }"
                    name="select"
                    rules="required"
...
export default {
    ...
    data: () => ({
        ...
        bookedRooms: [],
        tracks: ['Tor nr 1', 'Tor nr 2','Tor nr 3','Tor nr4','Tor nr 5','Tor nr 6','Tor nr 7','Tor nr 8'],
        checkbox: null,
        rules: {
